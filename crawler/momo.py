...
### 構建搜尋 URL
web = 'https://www.momoshop.com.tw/search/searchShop.jsp?keyword=餐券&searchType=1&curPage=1&_isFuzzy=0&showType=chessboardType&priceIndex={price_index}'
...
# 將資料寫入工作表
data = [['名稱', '價格','連結']] + list(zip(name_list, price_list,url_list))
